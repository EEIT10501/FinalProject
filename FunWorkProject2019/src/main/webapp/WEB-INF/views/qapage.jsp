						...
						<div id="A03" class="collapse" aria-labelledby="Q03"
							...
							<div class="card-body">
								<p>第一步 - 快速登入 打開打工趣的網站，點擊登入按鈕。 進入到登入畫面，你可以選擇任何一種方式登入
									<p>1.Google 帳號登入 <p>2.Email 帳號登入 假如你還沒有帳號，請點選最下方的「註冊帳號」 創立一個屬於自己的帳號唷~
									<p>第二步 - 填寫簡單履歷 登入後，就可以編輯自己的簡短履歷囉！<p>1.點擊設定齒輪<p>2.點擊簡短履歷 <p>3.開始撰寫你的履歷
									小技巧 使用好看的大頭貼 畫面乾淨、光線充足、背景不要凌亂 描述你的工作或是活動經驗，證明你的專長和能力！<p>第三步 -
									瞭解方便功能 尋找打工的同時，可以搭配方便簡單的功能快速找到想要的打工。
									<p>1.縣市分類－選擇你所在的縣市，或是選擇「自家」，在家裡輕鬆工作！ <p>2.距離排序－找出最靠近你的好工作。
									<p>3.追蹤功能－標記出有興趣的工作，之後可以到「追蹤」中瀏覽。<p> 4.已讀功能－閱讀過後會從深藍色變回淺藍色。
									<p>5即時溝通功能－輕鬆和雇主在線上溝通。 <p>第四步 - 一鍵應徵 遇到你喜歡的打工，就直接一鍵應徵吧！
									雇主就會立即收到你應徵的通知，接著也可以開始使用即時訊息與雇主溝通。<p> 舉報功能：<p>如果發現這個職缺刊載有以下問題時，可以點選「舉報此工作」<p> 1.八大行業 <p>2.傳直銷產業 <p>3.詐騙<p>4.薪水待遇與實係刊登不符
									<p>5.薪資工時違反勞基法<p> 6.雇主惡意拖欠薪水 <p>7.逾期<p> 8.其他（填寫你遇到的問題）
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="A01" class="collapse" aria-labelledby="Q01"
							data-parent="#QAlist">
							<div class="card-body">
								<p>1.進到 打工趣 網頁<p>2.循著「右上角大頭照 -> 帳號設定」進到 修改頁面 <p>3.在 email 欄位輸入新的
									email ( 記得密碼也必須填寫 <p>4.點擊設定<p> 5.完成
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="A02" class="collapse" aria-labelledby="Q02"
							...
							<div class="card-body">
								<p>1.到 重置密碼 頁面填寫你註冊的 email 並點擊重設密碼 （系統會寄出重置密碼通知信）
									<p>2.回到信箱，並點擊通知信的連結<p> 3.填寫新的密碼並送出<p>4.完成
							</div>
						</div>
					</div>
				...
				<div class="accordion text-left" id="QAlist1">
					<div class="card">
						...
						<div id="A1001" class="collapse" aria-labelledby="Q1001"
							data-parent="#QAlist1">
							<div class="card-body">
								<p>張貼工作職缺可依以下步驟進行：<p> 1.至打工趣張貼工作列表
									<p>2.點擊右上角「張貼工作」按鈕 <p>3.詳細填寫職缺資訊後送出<p> 4.回到張貼工作列表點擊「送審」按鈕<p> 5.完成
							</div>
						</div>
					</div>
					<div class="card">
					...
					<div class="card">
						...
						<div id="A102" class="collapse" aria-labelledby="Q102"
							data-parent="#QAlist1">
							<div class="card-body">
								<p>新增公司單位可以依照下列步驟進行：<p> 1.進入編輯打工的頁面 <p>2.找到單位欄位，點擊旁邊的「馬上建立」連結
									<p>3.填寫正確單位資訊並附上身分驗證文件 *1 <p>4.送出 <p>5.完成
									<p>成功建立後，回到編輯打工頁面，就可以在單位欄位的選單中，看到剛剛建立的公司。 * 身分驗證文件共有兩種類型，可擇一上傳。
									上傳前請先確認是否符合以下的規範： 。公司名片：名片必須能夠清楚看到 <p>1. 個人名字 <p>2. 公司名稱 <p>3. 公司統編：公司營業登記文件 (核准函或登記表)：文件必須能夠清楚看到<p> 1. 公司名稱 <p>2. 公司統編</p>
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="A103" class="collapse" aria-labelledby="Q103"
							...
							<div class="card-body">
								<p>應徵沒有收到回覆先不用緊張，部分雇主可能因為比較忙碌，沒有辦法回覆每一個應徵者，只會通知已錄取
									的人選，要如何確定你是不是那個人選呢？這個時候你有幾個做法：<p> 1.可以多傳即時訊息取得聯繫，善用平台好功能。
									<p>2.可以同時間投其他工作的履歷，多方增加機會。<p> 3.要謹慎使用殺手鐧，電話詢問雇主，表達出你的積極性，但不要嚇到雇主。
									<p>祝全天下的打工趣使用者都能順利找到合適的工作！
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="A104" class="collapse" aria-labelledby="Q104"
							...
							<div class="card-body">
								<p>當你看到職缺被駁回時先不用懊惱，也不用緊張。 造成職缺審核未過的原因有很多種，可以在以下幾個地方得知「駁回原因」：
									...
									<p>1.帳號的註冊信箱<p> 2. 網站 > 工作管理 > 未發佈 > 點擊任一職缺的 “失敗原因” 按鈕 <p>3.App > 已張貼 >
									未發佈 > 點擊任一職缺就可以看到<p> 如果對於駁回內容有疑問，歡迎來信與我們聯絡support@Funworkapp.com。
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="A105" class="collapse" aria-labelledby="Q105"
							data-parent="#QAlist1">
							<div class="card-body">
								<p>假使已經離職，或不再需要使用公司單位來張貼職缺，可以參考以下步驟退出公司單位：<p> 1.點擊右上角帳號
									<p>2.點擊「公司管理列表」 <p>3.點擊任一公司的退出按鈕
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="A106" class="collapse" aria-labelledby="Q106"
							...
							<div class="card-body">
								<p>公司審核失敗的處理步驟很簡單，只要進入公司單位的編輯頁面，並上傳合格的身分驗證文件後，就可以再 次送審職缺。
									進入公司單位的路徑如下： <p>1.點擊右上角雇主後台<p> 2.點擊「公司管理列表」<p> 3.點擊任一駁回公司的編輯按鈕 <p>P.S.
						...
						<div id="A107" class="collapse" aria-labelledby="Q107"
							...
							<div class="card-body">
								<p>即時訊息最棒的地方是能夠讓你和應徵者即時溝通、即時確認，當你想瞭解應徵者的經驗、所學專長、或是
									安排打工班次都能夠為你省下不少時間。 操作方式分別如下： <p>1.進入 已張貼頁面 <p>2.點擊任意職缺上的「聯絡應徵者」按鈕
									<p>3.點擊任意應徵者上的「聯絡應徵者」按鈕<p> 4.輸入訊息並按下 Enter
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="A108" class="collapse" aria-labelledby="Q108"
							data-parent="#QAlist1">
							<div class="card-body">
								<p>提供下列資訊至打工趣客服信箱，待人員確認無誤後，就會立即幫忙修正：<p>註明公司統編 、公司名稱 、要修改的內容
								<p>客服信箱：support@Funworkapp.com
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="A109" class="collapse" aria-labelledby="Q109"
							data-parent="#QAlist1">
							<div class="card-body">
								<p>職缺已額滿，不想再讓其他使用者看到職缺資訊，甚至應徵，可以將職缺設定為「已額滿」，你的職缺就不 會出現在網站 中，僅有那些已應徵的應徵者看的到。
								<p> 設定額滿的步驟如下：<p>1.至打工趣網站頁面<p> 2.點擊右上角「張貼工作」張貼工作列表<p>3.選擇任一發佈中職缺，並點選「設為已額滿」。
							</div>
						</div>
					</div>
				</div>
				...
				<div class="accordion text-left" id="QAlist2">
					<div class="card">
						...
						<div id="A201" class="collapse" aria-labelledby="Q201"
							...
							<div class="card-body">
								<p>應徵沒有收到回覆先不用緊張，部分雇主可能因為比較忙碌，沒有辦法回覆每一個應徵者，只會通知已錄取
									的人選，要如何確定你是不是那個人選呢？<p>這個時候你有幾個做法： <p>1.可以多傳即時訊息取得聯繫，善用平台好功能。
									<p>2.可以同時間投其他工作的履歷，多方增加機會。 <p>3.要謹慎使用殺手鐧，電話詢問雇主，表達出你的積極性，但不要嚇到雇主。
									<p>祝全天下的打工趣使用者都能順利找到合適的工作！
							</div>
						</div>
					...
					<div class="card">
						...
						<div id="A202" class="collapse" aria-labelledby="Q202"
							data-parent="#QAlist2">
							<div class="card-body">
								<p>使用一鍵應徵時 。雇主回信若使用打工趣的聊天室，網站將會有新訊息通知，同時時會寄到用戶註冊的信箱。<p>
									<p>雇主有可能經由履歷提供的聯絡方式（例如：電話號碼、通訊軟體）來連絡你。 使用email應徵時 。定時確認信箱的回信。
									<p>雇主有可能經由履歷提供的聯絡方式（例如：電話號碼、通訊軟體）來連絡你。 使用電話應徵時 。請留意雇主提到的通知錄取方式。
									<p>自行與雇主詢問通知錄取的方式與時限。
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="A203" class="collapse" aria-labelledby="Q203"
							data-parent="#QAlist2">
							<div class="card-body">
								<p>1.進入 已應徵頁面 <p>2.點擊任意職缺上的「聯絡雇主」按鈕<p> 3.輸入訊息並按下 Enter
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="A204" class="collapse" aria-labelledby="Q204"
							...
							<div class="card-body">
								<p>一鍵應徵 趣打工最方便的應徵方式，只要將自己的簡短履歷寫好後 ( 30 秒完成 )，點擊「應徵」按鈕，雇主就會看到
									你應徵的通知和個人檔案。<p> Email 應徵 使用自己的信箱寄履歷給對方。 <p>有些應徵會預先將履歷存成草稿，加快寄送履歷的速度。
									<p>電話應徵 直接撥電話給對方。 <p>雖然打電話很快，但在一般情況下，除非雇主有表明直接電話應徵，否則直接撥電話過去可是會造成雇主
									困擾的，使用上還是需要小心一些。
							</div>
						</div>
					</div>
					...
					<div class="card">
						...
						<div id="A205" class="collapse" aria-labelledby="Q205"
							data-parent="#QAlist2">
							<div class="card-body">
								<p>我要找到一份工作！ 簡潔有力的簡歷，是幫助你打中雇主心頭的關鍵！來看看以下的建議： 
								<p>挑選一張好看的大頭貼
									<p>1.畫面要乾淨清楚 <p>2.光線要充足 <p>3.背景不要過度雜亂 留下美好的第一印象吧！ <p>介紹你的專長及特色
									單純描述不夠力，寫出經驗來證明！<p> 1.有工作經驗的話，寫下幾個令人印象深刻的工作，並簡單描述你的經驗吧！
									<p>2.沒有工作經驗的話，寫下你曾經參加過的活動或是做過的事情，證明你的能力吧！
									<p>3.寫下一段簡短的自我介紹，凸顯你的個人特質跟專長吧！
							</div>
						</div>
					</div>
					<div class="card">
						...
						<div id="A206" class="collapse" aria-labelledby="Q206"
							data-parent="#QAlist2">
							<div class="card-body">
								<p>為了提供一個安全找打工的地方，打工趣的職缺為「人工審核」機制，審核過程大致為以下步驟：<p>
									<p>1.使用者第一次刊登公司職缺時，都需要先建立公司單位，並提供相關的身分驗證資料，例如公司名 片、政府營業登記文件
									(核准函或登記表)<p> 2.打工趣會依據公示網站以及身分驗證資料查驗單位是否屬實 <p>3.職缺內容都必須符合勞基法的規定<p> p.s.
									個人職缺不需建立公司單位 為了維護受雇者的權益，每個職缺都會經過以上步驟，請大家安心笑納<p> 關於個人簡歷
									為了確保使用者資訊的安全，在個人簡歷的部分： <p>1.打工趣不會主動提供任何使用者資料給雇主
									<p>2.當使用者按下應徵鍵後，雇主才會收到通知，並可以看到你的檔案 (未按下應徵鍵，雇主是完全看不 到的)
							</div>
						</div>
					</div>
				</div>
