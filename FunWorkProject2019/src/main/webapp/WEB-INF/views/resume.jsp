			...
			<div class="col-sm-8">
				<form:form method="POST" modelAttribute="resume" enctype="multipart/form-data">
					<fieldset>
						...
						<img width='50' height='50' src="<c:url value='/getPicture/${sessionScope.loginUser.userId}'/>">
						<form:input type="file" path="profilePart" id="ProfilePic" accept="image/gif, image/jpeg, image/png" class='form:input-large' />

						<div class="form-group row">
							<label for="name">姓名 :</label>

							<form:input type="text" path="name" class="form-control is-valid" id="name" placeholder="請填真實姓名 " required="required" />

						</div>
						<div class="form-group row">
							<label for="gender">性別 :</label>
							<form:select class="custom-select" path="gender" id="gender" required="required">
						...
						<div class="form-group row">
							...
							<form:input type="tel" id="phoneNum" path="phoneNum" maxlength="12" placeholder="0987 654 321" class="col-sm" pattern="09[1-8][0-9]([\-|\s]?)[0-9]{3}\1[0-9]{3}" />
						</div>
						<div class="form-group row">
							<label for="birth">生日: </label>
							<div class="input-append date form_datetime">
								<form:input size="16" type="date" name="bday" path="birth" id="birth" class="col-sm " />
						...
						<div class="form-group row">
							...
							<form:select class="custom-select" path="educationLevel" required="required">
						...
						<div class="form-group row">
                            ...
                            <div class="col-sm-2">
                            <form:input type="text" path="position1" class="form-control" id="position1" placeholder="工作名稱 "  />
                            </div>
                             <div class="col-sm-4">
                            <form:input type="text" path="term1" class="form-control" id="term1" placeholder="工作年資 "  />
                            </div>
                        </div>
						<div class="form-group row">
                            ...
                            <div class="col-sm-2">
                            <form:input type="text" path="position2" class="form-control" id="position2" placeholder="工作名稱 "  />
                            </div>
                             <div class="col-sm-4">
                            <form:input type="text" path="term2" class="form-control" id="term2" placeholder="工作年資 "  />
						    </div>
						</div>
						<div class="form-group row ">
							<label for="selfIntro">簡單自我介紹:</label>
							<form:textarea class="form-control" id="selfIntro" path="selfIntro" rows="3"></form:textarea>
						</div>
						<div class="form-group row">
							<div class="col-sm">
								<input type="submit" name="submit" class="btn btn-primary" id="submit" value="更新履歷" /> 
