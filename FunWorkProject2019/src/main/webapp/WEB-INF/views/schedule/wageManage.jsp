	...
	<div class="container-fluid">
		<div class="row m-3 justify-content-around">
			...
			<div class="col-sm-8">
				...
				<!--		日期篩選條件			-->
				<c:if test="${empty postJobList}">
					<h5>您目前尚未開立任何職缺或尚未錄取任何人，請先至<a href="<c:url value='/manageJob'></c:url>">職缺管理</a>新增職缺，</h5>
					<h5>或至<a href="<c:url value='/manageJob'></c:url>">邀約管理</a>錄取求職者以便排班試算薪資。</h5>
					
				</c:if>
				<c:if test="${!empty postJobList}">
					<form action="${pageContext.request.contextPath}/selectWage"
						method="post">
						<div>
