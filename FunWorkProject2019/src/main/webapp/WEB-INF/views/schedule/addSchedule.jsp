...
<body>
		...
		<div
			...
			<div id="message"></div>
			<div class='worker'>
				<form action="" method="post" accept-charset="utf-8" class="inline"
					id="work_form">
					...
					<div>
						...
						<div>
							<div>
								<label class="right"><font class="red">*</font>班別名稱</label>
							</div>
							<div>
						...
						<div>
							<div>
								<label class="right"><font class="red">*</font>起始時間</label>
							</div>
							<div>
								<input type="text" name="name" id="name" />
							</div>
						...
						<div>
							<div>
								<label class="right"><font class="red">*</font>結束時間</label>
							</div>
							<div>
								<input type="text" name="name" id="name" />
							</div>
						...
						<div>
							<div>
								<label class="right"><font class="red">*</font>休息時間</label>
							</div>
							<div>
								<input type="text" name="name" id="name" />
							</div>
