	...
	<div class="container-fluid">
		<div class="row m-3 justify-content-around">
			...
			<div class="col-sm-8">
				...
				<form:form modelAttribute="jobBean" action="receivedUpdatedPost" method="POST" id="jobForm">			
						<hr>
						...
						<div class="form-group row">
						    ...
						    <div class="col-sm-10">
						    	<form:input type="text" path="addresssup" class="form-control" id="addresssup" placeholder="請填寫地標、景點、捷運站、樓層等資訊"/>
						    </div>
						</div>
						<div class="form-group row">
							<label for="paidDate" class="col-sm-2 col-form-label">薪資發放日</label>
						    <div class="col-sm-10">
						    	<form:input type="text" path="paidDate" class="form-control" id="paidDate" placeholder="當日現領、活動結束後領、或任一日期"  required="required"/>
						    </div>
						</div>
						<div class="form-group row">
							<label for="rateByHour" class="col-sm-2 col-form-label">時薪</label>
						    <div class="col-sm-10">
						    	<form:input type="number" path="rateByHour" class="form-control" id="rateByHour" placeholder="請輸入時薪，只能提填寫數字" required="required" min="150"/>
						...
						<div class="form-group row">
						    ...
						    <div class="col-sm-10">
						    	<form:input type="text" path="jobPhone" class="form-control" id="jobPhone" pattern="09\d{2}\-?\d{3}\-?\d{3}" value="${sessionScope.loginUser.phoneNum}" />
						    </div>
						</div>
						<div class="form-group row">
							<label for="jobEmail" class="col-sm-2 col-form-label">聯絡信箱</label>
						    <div class="col-sm-10">
						    	<form:input type="text" path="jobEmail" class="form-control" id="jobEmail" value="${sessionScope.loginUser.email}" />
						    </div>
						</div>
						<div class="form-group row">
							<label for="jobEcontactmail" class="col-sm-2 col-form-label">聯絡人</label>
						    <div class="col-sm-10">
						    	<form:input type="text" path="contact" class="form-control" id="contact" value="${sessionScope.loginUser.userName}" />
						    </div>
						</div>
						<div class="form-group row">
						...
						<div class="form-group row">
						    ...
						    <div class="col-sm-10">
						    	<form:input type="text" path="comment" class="form-control" id="comment" placeholder="請留下訊息給審核人員，以便工作快速審核。" />
						    </div>
						</div>
						<div class="form-group row">
						    <div class="col-sm-10">
